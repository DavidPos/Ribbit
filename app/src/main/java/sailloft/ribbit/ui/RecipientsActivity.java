...
import sailloft.ribbit.utilis.FileHelper;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_send:
                ...
                if (message == null) {
                    ...
                    builder.setMessage(R.string.error_select_file)
                            .setTitle(R.string.error_select_title)
                            .setPositiveButton(android.R.string.ok, null);
                    AlertDialog dialog = builder.create();
                    dialog.show();
                }
            ...
            public void done(ParseException e) {
                if (e == null){
                    ...
                    builder.setMessage(getString(R.string.error_sending_message))
                            .setTitle(getString(R.string.error_select_title))
                            .setPositiveButton(android.R.string.ok, null);
                    AlertDialog dialog = builder.create();
                    dialog.show();
                }
